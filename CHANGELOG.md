...
### Added
- Repeatable quota-ledger backfill mixes pre-5.20 usage logs with an existing v5.20 ledger without dropping unlogged work or double-counting overlapping rows (`QUOTA_LEDGER_BACKUP_CONFIRMED=1 npx tsx scripts/migrate-quota-ledgers.ts`)
