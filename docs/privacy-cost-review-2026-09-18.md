...
| `BREVO_DAILY_EMAIL_LIMIT` | 500 | Login- en feedbackmailpogingen samen, ongeacht account/ontvanger. Een onzekere of mislukte verzending telt mee; bij uitputting wordt vóór fetch gestopt. |
