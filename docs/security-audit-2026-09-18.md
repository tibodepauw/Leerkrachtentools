...
Alle in deze audit bevestigde repositorybevindingen zijn op de herstelbranch aangepakt. De volledige Linux-CI van de verdiepte audit op commit `19ef5909b3b5f54feca91540545c2b9b89beec97` is [geslaagd](https://github.com/tibodepauw/Leerkrachtentools/actions/runs/35378685841): 550 tests, kernelisolatie, uitgebreide HTTP-/browserproeven en hersteltest. De branch is nog niet gemerged. Review en de hieronder beschreven controles van de echte VM, providers en offsite-backups blijven nodig. Een codeaudit bewijst niet de afwezigheid van alle onbekende fouten en is geen vrijgave van een nog niet bestaande productieomgeving.
